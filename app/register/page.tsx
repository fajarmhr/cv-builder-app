    ...
    <div className="grid min-h-screen bg-[var(--c-bg)] lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between bg-[#1b2230] p-12 text-[#edeff2] lg:flex">
        ...
        <div className="max-w-md">
          ...
          >
            One workspace, every version of your CV.
          </h2>
          <p
            className="mt-5 text-lg italic leading-relaxed text-[#aab1c2]"
            style={{ fontFamily: "var(--font-display)" }}
          >
            ATS-ready templates, live preview, and private token sharing for
            your portfolio.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-sm">
          <p className="eyebrow mb-2.5">Get started</p>
          <h1
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-xs font-semibold text-[var(--c-muted)]">
                Full name
              </Label>
              <Input
                id="fullName"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 rounded-lg border-[var(--c-border)] bg-[var(--c-input)] text-[var(--c-ink)]"
              />
              <p className="text-xs text-[var(--c-muted-2)]">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 rounded-lg border-[var(--c-border)] bg-[var(--c-input)] text-[var(--c-ink)]"
              />
              <p className="text-xs text-[var(--c-muted-2)]">At least 6 characters.</p>
            </div>
            <Button
              type="submit"
              disabled={isLoading}
